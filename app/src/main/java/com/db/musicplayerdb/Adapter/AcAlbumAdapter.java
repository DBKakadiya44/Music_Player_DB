...
public class AcAlbumAdapter extends RecyclerView.Adapter<AcAlbumAdapter.ViewHolder>
{
    Context context;
    ArrayList<MusicModel> audioList;
    ArrayList bitmapdata = new ArrayList();

    public AcAlbumAdapter(Context context, ArrayList<MusicModel> audioList) {
    ...
    @NonNull
    @Override
    public AcAlbumAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_song_fragment,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AcAlbumAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
